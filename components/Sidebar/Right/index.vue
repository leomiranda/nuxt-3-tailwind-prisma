<template>
	<div class="flex flex-col gap-4">
			...
			<SidebarRightPreviewCardItem v-for="whoToFollow in whoToFollowItems">
				<div class="flex flex-row items-center justify-between p-2">
					...
					<div class="flex h-full">
						<button
							class="px-4 py-2 text-xs font-bold text-white bg-black hover:bg-dim-900 rounded-full dark:text-black dark:bg-white dark:hover:bg-gray-200"
						>
							Follow
						</button>
					</div>
		...
		<footer>
			<ul class="flex flex-col mx-2 my-4 text-xs text-gray-500 gap-2">
